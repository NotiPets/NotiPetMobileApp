...
namespace NotiPetApp.Views.Authentication
{
    ...
    public partial class RegisterPage 
    {
        ...
        protected override CompositeDisposable ManageDisposables(CompositeDisposable disposables)
        {
            ...
            disposables.Add(this.BindValidation(ViewModel, wm => wm.Name, vw => vw.NameLB.ValidationMessage));
            disposables.Add(this.BindValidation(ViewModel,wm=>wm.LastName,vw=>vw.LastName.ValidationMessage));
